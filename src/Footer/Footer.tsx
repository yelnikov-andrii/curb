  ...
  return (
    ...
    <div className="container">
      ...
      <div className='footer__block-item'>
        ...
        <p className='footer__block-item_info'>
          © 2021 VADE Group Inc.
        </p>
      </div>
      <div className='footer__block-item'>
        <ul className='footer__block-list'>
          {headerItemsArr.map(item => (
            <li className='footer__block-list_item' key={item}>
      ...
      <div className='footer__block-item'>
        <a className='footer__block-item-email' href='mailto: team@vade.ai'>
          team@vade.ai
        </a>
        ...
        <a className='footer__block-item-address' href='https://goo.gl/maps/GLoVSYQgPngMqyDb9' target='_blank' rel="noreferrer">
        16 W Martin St. Suite <br />1101, Raleigh, NC 27601
        </a>
      </div>
      </div>
      <div className='footer__block-bottom'>
      <p className='footer__block-bottom_info'>
          privacy policy
        </p>
        <span className='footer__block-bottom_info'>
          terms of use
        </span>
      </div>
    </div>
