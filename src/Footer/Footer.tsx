...
export const Footer: React.FC<Props> = ({ headerItemsArr }) => {
  ...
  return (
    ...
    <div className="container">
      ...
      <p className='footer__block-bottom_info' data-aos="fade-out" data-aos-duration='2000'>
          privacy policy
        </p>
        <span className='footer__block-bottom_info' data-aos="fade-out" data-aos-duration='2000'>
          terms of use
        </span>
      </div>
    </div>
